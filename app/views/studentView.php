  ...
  <body>
    <div class="d-flex">
      <div class="bg-light" style="width: 5%; height: 100vh">
        <div
          class="d-flex flex-column flex-fill align-items-center align-content-center justify-content-evenly"
      ...
      <div
        ...
        style="width: 95%; height: 100vh; background-color: #cccfc7"
      >
        <div class="container text-center">
          <div class="row align-items-start gap-4">
            <div
              class="col-3 bg-light d-flex align-items-center justify-content-evenly"
              style="border-radius: 15px; height: 400px"
            >

  ...
  <div class="d-flex">
    ...
    <div class="d-flex justify-content-center align-items-center " style="width:80%; height: 100vh;">
      <div class="m-5 img-fluid d-flex justify-content-center align-items-center flex-column" style="
            ...
            border-radius: 20px;
          ">
        <a href="class" class="bg-dark-subtle mb-4 p-2 d-flex flex-row justify-content-center align-items-center" style="text-decoration: none; background: #CCCFC7;
        ...
        <a href="studentDetails" class="bg-dark-subtle p-2 d-flex flex-row justify-content-center align-items-center" style="text-decoration: none; background: #CCCFC7;
            box-shadow: inset 0px 4px 4px rgba(0, 0, 0, 0.25);
            border-radius: 10px; width: 450px;">
